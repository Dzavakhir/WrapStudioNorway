...
- `-duotone.jpg` is a flat maroon-ink/maroon/blush duotone (opaque JPEG, own rectangle) -- works on any ground in the palette; reach for it where a graphic, single-colour-family treatment suits the moment better than a full-colour photo (a bold full-bleed wash, a small stamp-like inset).
