"""Spiker rasmlarini yagona (jamoa) uslubga keltirish: iliq burgundi-duoton grading."""
...
def apply_grade(im, mix, contrast, brightness, high, saturation=0.72):
    """RGBA kesim -> gradinglangan RGBA (alfa kanali tozalangan)."""
    rgb = im.convert('RGB')
    ...
    # fondagi juda past alfa qiymatlari nol qilinadi (to'rtburchak hoshiya yo'qoladi)
